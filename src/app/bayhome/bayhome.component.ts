      ...
      this.bay2_INN = this._toolsListed.filter(data=>{
        ...
        this.bay3_INN =  this._toolsListed.filter(data=>{
          ...
          this.bay6A_INN =  this._toolsListed.filter(data=>{
            ...
            this.bay6A_INN.forEach(function (value) {
            if(value.status === 'IN'){
              $('#bay6A_INN').css({fill: "#ffff80"});
            }
            else if (value.status === 'ID') {
              $('#bay6A_INN').css({fill: "#ff7f7f"});
            }
            else if (value.status === 'PR') {
              $('#bay6A_INN').css({fill: "#c2de80"});
            }
            else if (value.status === 'MA') {
              $('#bay6A_INN').css({fill: "#9ac3f5"});
            }
            })
          ...
          this.bay6B_INN =  this._toolsListed.filter(data=>{
            ...
            if(value.status === 'IN'){
              $('#bay6B_INN').css({fill: "#ffff80"});
            }
            else if (value.status === 'ID') {
              $('#bay6B_INN').css({fill: "#ff7f7f"});
            }
            else if (value.status === 'PR') {
              $('#bay6B_INN').css({fill: "#c2de80"});
            }
            else if (value.status === 'MA') {
          ...
          this.bay7_INN =  this._toolsListed.filter(data=>{
            ...
            this.bay8A_INN =  this._toolsListed.filter(data=>{
              return data.bay_number=='8A_INN' && data.is_active == true
            });
              this.bay8A_INN.forEach(function (value) {
              if(value.status === 'IN'){
                $('#bay8A_INN').css({fill: "#ffff80"});
              }
              else if (value.status === 'ID') {
                $('#bay8A_INN').css({fill: "#ff7f7f"});
              }
              else if (value.status === 'PR') {
                $('#bay8A_INN').css({fill: "#c2de80"});
              }
              else if (value.status === 'MA') {
                $('#bay8A_INN').css({fill: "#9ac3f5"});
              }
              })
            
              this.bay8B_INN =  this._toolsListed.filter(data=>{
                return data.bay_number=='8B_INN' && data.is_active == true
              });
                this.bay8B_INN.forEach(function (value) {
                if(value.status === 'IN'){
                  $('#bay8B_INN').css({fill: "#ffff80"});
                }
                else if (value.status === 'ID') {
                  $('#bay8B_INN').css({fill: "#ff7f7f"});
                }
                else if (value.status === 'PR') {
                  $('#bay8B_INN').css({fill: "#c2de80"});
                }
                else if (value.status === 'MA') {
                  $('#bay8B_INN').css({fill: "#9ac3f5"});
                }
                })
            ...
            this.bay15_INN =  this._toolsListed.filter(data=>{
              ...
              this.bay16_INN =  this._toolsListed.filter(data=>{
                ...
                this.bay19_INN =  this._toolsListed.filter(data=>{
                  ...
                  this.bay19_INN.forEach(function (value) {
                  if(value.status === 'IN'){
                    $('#bay19_INN').css({fill: "#ffff80"});
                  }
                  else if (value.status === 'ID') {
                    $('#bay19_INN').css({fill: "#ff7f7f"});
                  }
                  else if (value.status === 'PR') {
                    $('#bay19_INN').css({fill: "#c2de80"});
                  }
                  else if (value.status === 'MA') {
